...
Insert into USER (`id`, `username`, `password`, `enabled`, `admin_vip`)
values (1, 'bubu', '$2a$10$/3J0dSgO0d/acwbeZJ0aAOIdhqtETsWAfvHNOv3aRYRy3cukE/q0i', 1, true);
Insert into USER (`id`, `username`, `password`, `enabled`, `editor_vip`)
values (2, 'test', '$2a$10$GItMgw5DJRvhkVACOKLuPuA37b38iw9Jj3qInKXA7kMwCg4XTniIW', 1, true);
Insert into USER (`id`, `username`, `password`, `enabled`, `guest_vip`)
